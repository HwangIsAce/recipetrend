...
class RecipeTrend(BertPreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
    ) -> Union[Tuple[torch.Tensor], CustomMaskedLMOutput]:
        r"""
        ...
        return CustomMaskedLMOutput(
            ...
            output_aug_l1=outputs['output_aug_l1'],
            output_aug_l2=outputs['output_aug_l2'],
            output_aug_h1=outputs['output_aug_h1'],
            output_aug_h2=outputs['output_aug_h2'],
            output_aug_b1=outputs['output_aug_b1'],
            output_aug_b2=outputs['output_aug_b2'],
